...
public class BinaryTreeFromPostorderInorder {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		Postorder.preorderTraversal(buildTree(new int[] { 9, 3, 15, 20, 7 }, new int[] { 9, 15, 7, 20, 3 }));
		System.out.println();
		Inorder.preorderTraversal(buildTree(new int[] { 9, 3, 15, 20, 7 }, new int[] { 9, 15, 7, 20, 3 }));
	}
