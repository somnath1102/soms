...
public class BinaryTreeFromPreorderInorder {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		Postorder.postorderTraversal(buildTree(new int[] { 3, 9, 20, 15, 7 }, new int[] { 9, 3, 15, 20, 7 }));
		System.out.println();
		Inorder.inorderTraversal(buildTree(new int[] { 3, 9, 20, 15, 7 }, new int[] { 9, 3, 15, 20, 7 }));
	}
